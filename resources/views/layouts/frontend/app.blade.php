...
<head>
    ...
    <!-- Title -->
    <title>PKBM Pelita Mekarsari | {{ $title ?? '' }}</title>
    ...
    <header class="header-area">
        ...
        <div class="top-header-area d-flex justify-content-between align-items-center">
            ...
            <div class="contact-info">
                <a href="#"><span>Phone:</span>0813-8081-2727</a>
                <a href="#"><span>Email:</span> masiskandar78@gmail.com</a>
            </div>
            <!-- Follow Us -->
            <div class="follow-us">
                <span>Follow us</span>
                <a href="https://www.facebook.com/iskandar.adinata.75"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            </div>
        </div>
