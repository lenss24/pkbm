                ...
                <div class="contact--info mt-50">
                    ...
                    <ul class="contact-list">
                        <li>
                            ...
                            <h6>19:30 WIB  - 20:30 WIB</h6>
                        </li>
                        <li>
                            <h6><i class="fa fa-phone fa-fw" aria-hidden="true"></i> No Telp</h6>
                            <h6>0813-8081-2727</h6>
                        </li>
                        <li>
                            <h6><i class="fa fa-envelope fa-fw" aria-hidden="true"></i> Email</h6>
                            <h6>masiskandar78@gmail.com</h6>
                        </li>
                        <li>
                            <h6><i class="fa fa-map-pin fa-fw" aria-hidden="true"></i> Alamat</h6>
                            <h6>PKBM Pelita Harapan Mekarsari Jalan Masjid At-Taubah rt04 rw 02 Desa Cigarogol Cileungsi Jawa Barat 16820 </h6>
                        </li>
                    </ul>
                </div>
            </div>
