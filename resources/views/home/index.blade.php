...
@section('content')
<!-- ##### Hero Area Start ##### -->
<section class="hero-area bg-img bg-overlay-2by5" style="background-image: url({{ asset('img/bg') }}/banner.jpg);">
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <!-- Hero Content -->
                <div class="hero-content text-center">
                    <h2>Selamat Datang di PKBM Pelita Mekarsari Cileungsi</h2>
                    <a href="login" class="btn clever-btn">Register Sekarang!!</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="regular-page-area section-padding-100 mt-5 mb-4">
    <div class="col-lg-9 mx-auto">
        <div class="card">
            <div class="card-header">PKBM Pelita Mekarsari</div>
            <div class="card-body">
                <p class="lead">
